...
class WYSIWYGEmbedTest extends JavascriptTestBase {
  ...
  public function testTopicEmbed() {
    ...
    //   | Title | Embed WYSIWYG |
    $this->getSession()->getPage()->fillField('Title', 'Embed WYSIWYG');
    ...
    $this->getSession()->getPage()->fillField('URL', 'https://www.youtube.com/watch?v=kgE9QNX8f3c');
    ...
    $this->assertSession()->pageTextContains('Topic Embed WYSIWYG has been created.');
